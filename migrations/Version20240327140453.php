 ...
 */
final class Version20240327140453 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE url_photo_profil url_photo_profil VARCHAR(255) NOT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE `user` CHANGE url_photo_profil url_photo_profil VARCHAR(255) DEFAULT \'default_profile.jpg\'');
